...
export interface Safe_migrationInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MIGRATION_SINGLETON"
...
export interface Safe_migration extends BaseContract {
  connect(runner?: ContractRunner | null): Safe_migration;
  waitForDeployment(): Promise<this>;

  interface: Safe_migrationInterface;
