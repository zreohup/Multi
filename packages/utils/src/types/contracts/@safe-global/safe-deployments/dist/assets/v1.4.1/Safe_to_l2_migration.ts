...
export interface Safe_to_l2_migrationInterface extends Interface {
  getFunction(
...
export interface Safe_to_l2_migration extends BaseContract {
  connect(runner?: ContractRunner | null): Safe_to_l2_migration;
  waitForDeployment(): Promise<this>;

  interface: Safe_to_l2_migrationInterface;
