...
const addNotificationServiceFilesToProject = (c, props) => {
    const serviceExtensionFilesFolderPath = path.join(require.resolve('@safe-global/notification-service-ios/package.json'), '../ios-notification-service-files/');
    ...
    return (0, config_plugins_1.withXcodeProject)(updatedConfig, (nc) => {
        ...
        const mainGroup = x.addPbxGroup([...config_1.FILES_TO_ADD, config_1.EXTENSION_SERVICE_FILE], config_1.EXTENSION_SERVICE_NAME, config_1.EXTENSION_SERVICE_NAME);
